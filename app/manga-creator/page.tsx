  ...
  return (
    <div className="paper-stage min-h-screen text-zinc-100">
      <main className="mx-auto w-full max-w-7xl px-6 py-16 md:px-10">
        ...
        <Link
          href="/upload"
          className="rounded-lg border border-zinc-600 px-4 py-2 text-sm font-medium text-zinc-200 transition hover:border-zinc-500 hover:bg-zinc-900"
        >
          Back to upload
        </Link>
        </div>
        ...
        <aside className="space-y-8 lg:sticky lg:top-24 lg:self-start">
          <section className="rounded-2xl border border-zinc-700/60 bg-zinc-900/70 p-5 shadow-lg shadow-black/20">
            <h2 className="text-lg font-semibold text-amber-200">Quick tutorial</h2>
            <ol className="mt-4 list-decimal space-y-3 pl-5 text-sm text-zinc-300">
              <li>
                <strong className="text-zinc-100">Thumbnails first.</strong> Tiny
                boxes to plan what happens in each panel—stick figures are fine.
              </li>
              <li>
              ...
              <li>
                ...
                when you like a page, then you can trim or combine in another
                app if needed.
              </li>
            </ol>
          </section>
